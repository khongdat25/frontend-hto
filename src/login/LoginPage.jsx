      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="mb-2">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <a href="#" className="forgot-password" style={{ fontSize: '11px' }} onClick={(e) => { e.preventDefault(); onSwitchToForgot(); }}>Quên mật khẩu?</a>
          </div>
        ...
        <div className="mb-3">
          <div className="form-check">
            <input
              ...
              {...register("remember")}
            />
            <label className="form-check-label" htmlFor="remember" style={{ fontSize: '12px' }}>Ghi nhớ đăng nhập</label>
          </div>
        </div>
